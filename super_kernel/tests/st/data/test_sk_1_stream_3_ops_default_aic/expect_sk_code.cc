...
extern "C"  __global__ __attribute__((aligned(512))) __aicore__ void auto_gen_te_superkernel_1_stream_3_ops_kernel(void) {
...
static const struct FunLevelMixCoreType te_superkernel_1_stream_3_ops_mix_aic_section __attribute__ ((used, section (".ascend.meta.te_superkernel_1_stream_3_ops_mix_aic"))) = { {{F_TYPE_KTYPE, sizeof(unsigned int)}, K_TYPE_MIX_AIC_MAIN},    {{F_TYPE_MIX_TASK_RATION, sizeof(unsigned int)}, 1, 0} };
#endif
#endif
