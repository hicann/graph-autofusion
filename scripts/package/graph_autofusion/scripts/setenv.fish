...
function get_install_param
    ...
    set -l install_info_key_array GRAPH_AUTOFUSION_Install_Type GRAPH_AUTOFUSION_Feature_Type GRAPH_AUTOFUSION_UserName GRAPH_AUTOFUSION_UserGroup GRAPH_AUTOFUSION_Install_Path_Param GRAPH_AUTOFUSION_Arch_Linux_Path GRAPH_AUTOFUSION_Hetero_Arch_Flag
...
function get_install_dir
    ...
    set -l hetero_arch (get_install_param "GRAPH_AUTOFUSION_Hetero_Arch_Flag" "$install_info")
