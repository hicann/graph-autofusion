...
constexpr const char *kGraphName = "pgo_add_abs_inductor_concat";
...
TEST_F(TestBackendPgoAddAbsInductorConcatSplitCompile, SplitCompileChainWorks) {
  ...
  ASSERT_EQ(autofuse::tests::RunHostCompile(tiling_def, host_code, host_bin, "pgo_add_abs_inductor_concat", ""), 0);
