...
extern "C" __global__ __aicore__ void chebyshev_polynomial_v_store_test(GM_ADDR x1, GM_ADDR y1, GM_ADDR workspace,
                                                                        GM_ADDR tiling);
...
class E2EBackendChebyshevPolynomialVStoreCode : public testing::Test,
                                                public testing::WithParamInterface<std::vector<int>> {};

TEST_P(E2EBackendChebyshevPolynomialVStoreCode, CalculateCorrect) {
  ...
  ICPU_RUN_KF(chebyshev_polynomial_v_store_test, tiling_data.block_dim, reinterpret_cast<uint8_t *>(x),
...
INSTANTIATE_TEST_SUITE_P(CalcWithDifferentShape, E2EBackendChebyshevPolynomialVStoreCode,
