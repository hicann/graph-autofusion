...
class TestBackendHermitePolynomialHeStoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendHermitePolynomialHeStoreE2e, HermitePolynomialHeStoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::HermitePolynomialHeStoreFusedGraph(2);
  ...
  try {
    ...
    EXPECT_NE(hermite_result.kernel.find("HermitePolynomialHeExtend"), std::string::npos);
