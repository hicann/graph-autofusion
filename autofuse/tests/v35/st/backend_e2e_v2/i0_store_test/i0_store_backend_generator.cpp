...
class TestBackendI0StoreE2e : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(TestBackendI0StoreE2e, I0StoreE2eCodegen) {
...
#define GET_TILING_DATA(t, tiling)  AutofuseTilingData t = *(AutofuseTilingData*)tiling;
  ...
  auto graph = ascir::ShareGraph::I0StoreFusedGraph(2);
  ...
  try {
    ...
    EXPECT_NE(i0_result.kernel.find("I0Extend"), std::string::npos);
