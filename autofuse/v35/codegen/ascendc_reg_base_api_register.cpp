...
#include "reduce/reduce_common_reg_base.h"
                                                  }) +
...
#include "cos_reg_base.h"
  ...
  const std::string kAscendcAtanRegBaseStr = {
#include "atan_reg_base.h"
  };
  const std::string kAscendcAsinRegBaseStr = {
#include "asin_reg_base.h"
  };
