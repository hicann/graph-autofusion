...
#ifndef AUTOFUSE_REDUCE_EXTEND_REDUCE_COMMON_RA_REUSE_ALIGN_C310_IMPL_H
#define AUTOFUSE_REDUCE_EXTEND_REDUCE_COMMON_RA_REUSE_ALIGN_C310_IMPL_H
...
__simd_vf__ inline void ReduceRAOverVLVFImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
                                             uint16_t dimA, uint32_t dimR, uint32_t mainR, uint32_t tailR,
                                             uint16_t loopANum, uint16_t loopANumFinal, uint16_t folds,
                                             uint16_t avgFolds, uint16_t foldZero, uint16_t foldOne, uint16_t foldTwo,
                                             uint16_t foldThree) {
...
__aicore__ inline void ReduceRAOverVLImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr, uint16_t dimA,
  ...
  ReduceRAOverVLVFImpl<T, Trait, Binaryfunc, isReuseSource>(dstAddr, srcAddr, tmpAddr, dimA, dimR, mainR, tailR,
                                                            loopANum, loopANumFinal, folds, avgFolds, foldZero, foldOne,
                                                            foldTwo, foldThree);
}
...
template <class T, const Reg::RegTrait &Trait, auto Binaryfunc, bool isReuseSource>
__simd_vf__ inline void ReduceRALessThanVLVFImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
                                                 uint32_t dimA, uint32_t dimR, uint32_t mainR, uint32_t tailR,
                                                 uint16_t folds, uint16_t avgFolds, uint16_t foldZero, uint16_t foldOne,
...
__aicore__ inline void ReduceRALessThanVLImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
  ...
  ReduceRALessThanVLVFImpl<T, Trait, Binaryfunc, isReuseSource>(dstAddr, srcAddr, tmpAddr, dimA, dimR, mainR, tailR,
                                                                folds, avgFolds, foldZero, foldOne, foldTwo, foldThree);
}
...
template <class T, const Reg::RegTrait &Trait, auto Binaryfunc, bool isReuseSource>
__simd_vf__ inline void ReduceRAConcatVFImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
                                             uint32_t dimA, uint32_t dimR, uint16_t foldTime, uint32_t mainR,
                                             uint32_t tailR) {
...
template <class T, const Reg::RegTrait &Trait, auto Binaryfunc, bool isReuseSource>
__aicore__ inline void ReduceRAConcatImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr, uint32_t dimA,
                                          uint32_t dimR) {
  constexpr uint16_t vlSize = GetVecLen() / sizeof(T);
  uint16_t foldTime = AscendC::Internal::FindClosestPowerOfTwo(dimR);
  ...
  ReduceRAConcatVFImpl<T, Trait, Binaryfunc, isReuseSource>(dstAddr, srcAddr, tmpAddr, dimA, dimR, foldTime, mainR,
                                                            tailR);
}
...
__aicore__ inline void ReduceRAImpl(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr, uint32_t dimA,
  ...
  if (dimA <= vlSize / ReduceOpInternal::REGULAR_FOLD_NUM || dimA > ReduceOpInternal::U16_STRIDE) {
    ...
    ReduceRAOverVLImpl<T, Trait, Binaryfunc, isReuseSource>(dstAddr, srcAddr, tmpAddr, static_cast<uint16_t>(dimA),
                                                            dimR);
  }
}

template <class T, const Reg::RegTrait &Trait, auto Binaryfunc, bool isReuseSource>
__simd_vf__ inline void ReduceRAB64ReuseSourceVF(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
                                                 uint32_t dimA, uint32_t dimR, uint32_t mainR, uint32_t tailR,
                                                 uint16_t loopANum, uint16_t loopANumFinal, uint16_t folds,
...
__aicore__ inline void ReduceRAB64ReuseSource(__ubuf__ T *dstAddr, __ubuf__ T *srcAddr, __ubuf__ T *tmpAddr,
  ...
  ReduceRAB64ReuseSourceVF<T, Trait, Binaryfunc, isReuseSource>(dstAddr, srcAddr, tmpAddr, dimA, dimR, mainR, tailR,
                                                                loopANum, loopANumFinal, folds, avgFolds, foldZero,
                                                                foldOne, foldTwo);
}
}  // namespace ReduceExtendInternal
}  // namespace AscendC
#endif  // AUTOFUSE_REDUCE_EXTEND_REDUCE_COMMON_RA_REUSE_ALIGN_C310_IMPL_H
